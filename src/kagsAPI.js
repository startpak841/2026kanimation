...
function buyerFromRow(r) {
  ...
  return {
    ...
    confirmedTime: r.confirmed_time || null,
    confirmedExhibitorId: r.confirmed_exhibitor_id || null,
...
function buyerToRow(b) {
  return {
    ...
    confirmed_date: b.confirmedDate || null,
    confirmed_time: b.confirmedTime || null,
    confirmed_exhibitor_id: b.confirmedExhibitorId || null,
